...
function showCakeCeremony() {
    ...
    setTimeout(() => {
        ...
        knife.style.transform = "translateX(-30px) translateY(30px) rotate(0deg)";
    }, 1000);

    setTimeout(() => {
        // Small shake before cutting
        knife.style.transform = "translateX(-32px) translateY(32px) rotate(-10deg)";
    }, 1400);

    setTimeout(() => {
        // Knife slices downward
        knife.style.transform = "translateX(-30px) translateY(60px) rotate(45deg)";
        cakeSlice.style.opacity = "1"; // Show cake slice
        cakeSlice.style.transform = "translateX(20px) translateY(-15px) rotate(10deg)"; // Move slice outward
    }, 1800);
    ...
    // Play cutting sound
    const cutSound = new Audio("cut-sound.mp3");
    cutSound.play();
}
